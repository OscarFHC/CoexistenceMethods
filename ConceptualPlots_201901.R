...
##### Parameter values for the model ################################
##### Simulative invasion experiment and plotting ###################
...
FD_S <- plot_grid(FX, FY, TotD, labels = c("a)", "b)", "c)"), ncol = 1, align = 'V')

ggsave(filename = "D:/Manuscript/CoexistenceMethods/Ver3/Fig1_FD.pdf", 
...
ggsave(filename = "D:/Manuscript/CoexistenceMethods_Figs/Ver3/Fig2_LV.pdf", 
...
ggsave(filename = "D:/Manuscript/CoexistenceMethods_Figs/Ver3/Fig3_Sen.pdf", 
