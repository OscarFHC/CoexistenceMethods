...
# ra = ra, rb = rb, ka = ka, kb = kb, aab1 = goodfit5ord$aabest1[1], aba1 = goodfit5ord$abaest1[1],
# aab2 = goodfit5ord$aabest2[1], aba2 = goodfit5ord$abaest2[1], d = 0.1, b = goodfit5ord$b[1])
# 
...
write.csv(goodfit, file = "goodfit93.csv")