...
#finalparms = c(ICa = 1, ICb = 4 , ra = 0.55, rb = 0.37, ka = 1184418, kb = 36697, aab = 38.8413, aba =0.0348 , d = 0.1)
#
#ICa = 1
#ICb = 4
#ra = 0.55
...
plot(1:24, fish(23)[ ,1], pch = NA, xlab = "time (days)",
  ylab = "Density (cells/mL)", xaxt = 'n', ylim = c(min(0, max(DATA[1:y, countera: counterb], na.rm=T) + 3000))
