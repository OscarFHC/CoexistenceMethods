...
kb= 113211
      ...
      parmsstart = list ("ICa" = 4000, "ICb" = 200, "aab" =-1200, "aba"= 0.03)
...
finalparms = as.numeric(finalparms)
 ...
 fish<- function(x) {
  ...
  out[2, 2] = as.numeric(finalparms[2])
	for(i in 3:t){out[i, ] = M_2(c(out[i-1, 1], out[i-1, 2]), parms)+c(1,1)}
	return(out)
  }
...
text(24, max(DATA[1:y, counterb] ,na.rm = T) +500, "33")
